function a(i){return i==null?"0":i.toLocaleString("ar-DZ")}function $(i){if(!i)return"-";const t=Math.floor(i/60),s=i%60;return t>0?`${t}س ${s}د`:`${s}د`}function o(i){return{"01":"يناير","02":"فبراير","03":"مارس","04":"أبريل","05":"مايو","06":"يونيو","07":"يوليو","08":"أغسطس","09":"سبتمبر",10:"أكتوبر",11:"نوفمبر",12:"ديسمبر"}[i]??i}function w(i){const{salary:t,employee:s,companyName:g,attendanceRecords:p=[],advances:b=[],violations:m=[],leaveRequests:d=[],vacationRequests:n=[],bonuses:v=[]}=i,l=p.filter(e=>!e.isAbsent&&e.checkInTime),r=p.filter(e=>e.isAbsent),f=(t.lateDeductions||0)+(t.advanceDeductions||0)+(t.violationDeductions||0)+(t.otherDeductions||0),h=`<!DOCTYPE html>
